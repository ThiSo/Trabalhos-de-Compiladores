...
etapa2: obj/main.o obj/parser.tab.o obj/lex.yy.o obj/data_structures.o obj/aux.o
	gcc -o etapa2 obj/main.o obj/parser.tab.o obj/lex.yy.o obj/data_structures.o obj/aux.o -lfl
